...
@section('content')
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h1 class="text-center mb-4">Yeni Kitap Ekle</h1>
                ...
                <form id="bookForm" action="{{ route('books.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('book_name') is-invalid @enderror" id="book_name" name="book_name" required value="{{ old('book_name') }}">
                        @error('book_name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('author_name') is-invalid @enderror" id="author_name" name="author_name" required value="{{ old('author_name') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('number_of_pages') is-invalid @enderror" id="number_of_pages" name="number_of_pages" required value="{{ old('number_of_pages') }}">
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary btn-block">Kitap Ekle</button>
                    </div>
                </form>
            </div>
        </div>
